...
$mail->Username   = 'enquiry@khanakhazananj.com';       // SMTP username
$mail->Password   = "Khana@Khazana@2210";                           // SMTP password
...
//Recipients
$mail->setFrom('enquiry@khanakhazananj.com', 'Contact Us');
$mail->addAddress($contact_email, $form_name); 
$mail->addAddress('enquiry@khanakhazananj.com', 'Contact Us'); 
...
// $database = "khana_khazana";
 ...
 $password = "KhanaKhazana@2210";
 $database = "u768511311_khana_khazana";
															...
															<tr>
															   <td align="center" style="font-size:0px;padding:10px 25px;word-break:break-word;">
																  <div style="font-family:OpenSans, Helvetica, Tahoma, Arial, sans-serif;font-size:12px;font-weight:400;line-height:20px;text-align:center;color:#4F4F4F;">
																	 <br /> &copy; 2025 Khana Khazana. All rights reserved.
																	 <br />
																  </div>
															   </td>
															</tr>
